...
public class CinemaService {
    ...
    public String getCinemaUUID(String number) {
        String cinemaUUID = redisUtils.get(RedisKeyPrefixEnums.CINEMA+number);

        if (Objects.isNull(cinemaUUID))
            throw new NotCinemaMemberException();
