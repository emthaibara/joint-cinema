...
import cn.scbc.servicevideouploadapi.enums.CodeMsgEnum;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    @ExceptionHandler(BuildChunkFolderException.class)
    public Result<String> buildChunkFolderExceptionHandler(){
        return new Result<>(CodeMsgEnum.NOT_EXITS.getCodeMsg());
    }
