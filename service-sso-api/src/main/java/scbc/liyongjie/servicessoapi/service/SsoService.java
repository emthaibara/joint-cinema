...
public class SsoService {
    ...
    private String cacheToken(String number){
        ...
        redisUtil.set(PrefixEnum.TOKEN.getPrefix()+jwt, secret,RedisUtil.TOKEN_EXPIREDTIME);
        redisUtil.set(PrefixEnum.NUMBER.getPrefix()+number, jwt,RedisUtil.TOKEN_EXPIREDTIME);
